...
//import { Tekcify } from 'tekcify-auth';
    ...
    return (
      <div className='flex  justify-center items-center h-screen'>
          <div className='space-x-2 flex flex-col justify-center items-center px-5 py-4'>
            <div className='text-2xl text-center bg-gradient-to-r from-orange-600 to-red-800 text-transparent bg-clip-text mb-6 font-semibold'>Welcome to WumzyWears</div>
           
            <h1 className='text-neutral-900 text-center text-[15px]'>Create your account and purchase<br/> high quality wears.</h1>
            

            <button className="bg-black rounded-3xl py-3 px-6 mx-3 flex items-center justify-center space-x-3 my-6 cursor-pointer" >
              <Image
